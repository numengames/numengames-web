<!-- Reproduced verbatim from standards/2026_08_18-Sistema_de_Diseno-v5.1.0.md §19.5 —
     ...
     Known errata in the source, kept verbatim on purpose: the first line of
     the fragment still names v5.0.0. Reported for a patch bump upstream; this
     copy does not silently correct it, because a verbatim copy that edits is
     not a copy. -->
