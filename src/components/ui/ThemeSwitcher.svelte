...
<button on:click={toggleTheme} class={`inline-flex items-center justify-center p-2 rounded-md text-primary-beige hover:text-primary-coralRed transition-colors ${className}`} aria-label={`Switch to ${currentTheme === "dark" ? "light" : "dark"} mode`}>
