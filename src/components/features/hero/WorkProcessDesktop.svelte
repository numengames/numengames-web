...
<Container className="xl:flex hidden flex-col items-center justify-center pt-12 pb-60" bgColor="bg-primary-panther">
	<div class="flex flex-col items-center relative">
		<div class="h-[180px] sticky top-[100px] flex flex-col items-center z-20 text-primary-beige">
		...
		{#each steps as step, index (index)}
			<div class="max-w-[450px] 2xl:max-w-[600px] work-process-step sticky opacity-100 transition-opacity duration-700 p-6 rounded-lg mx-12 border border-[rgba(239,165,23,0.18)] bg-[linear-gradient(135deg,rgba(41,36,32,0.94),rgba(30,26,23,0.96),rgba(41,36,32,0.92))]" style={`top: ${280 + index * 120}px; z-index: ${3 + index}; transform: rotate(${index % 2 === 0 ? "-3deg" : "3deg"}); margin-bottom: ${[144, 0, -144][index] || 0}px; box-shadow: 0 0 32px rgba(239, 165, 23,0.14), 0 18px 48px rgba(20, 17, 15,0.36);`}>
				...
				<div class="p-6 mt-2">
					...
					<p class="text-primary-beige/70 font-thin mt-6 text-base 2xl:text-xl 3xl:text-2xl">
						{step.description}
					</p>
					{#if index === steps.length - 1}
						<div class="relative inline-block">
							<button class="text-base px-6 py-3 rounded-md border border-solid border-[rgba(239,165,23,0.35)] backdrop-blur-[25px] shadow-[0_0_20px_0_rgba(239,165,23,0.28)] mt-10 text-primary-beige form-toggle-button bg-[rgba(239,165,23,0.06)] hover:bg-[rgba(239,165,23,0.12)] transition-colors"> Digital Team Readiness Assessment </button>
