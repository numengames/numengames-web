...
<Container
	className="xl:hidden flex flex-col justify-center items-stretch text-primary-beige px-4 pt-24 xl:pt-28"
	...
	<section class="flex flex-col justify-between w-full h-full mt-10">
		<p
