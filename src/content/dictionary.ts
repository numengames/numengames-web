...
const es: SiteDictionary = {
	...
	home: {
		...
		supportLine:
			"Diseño a medida. Ejecución en vivo. Entregables después del evento.",
		bloque2: {
			title:
				"No añadimos un juego al programa. Diseñamos cómo participa la gente.",
			...
			sequence: [
				...
				"Aportaciones",
				"Conocimiento conservado",
			],
			sequenceNote:
				"Es una simplificación explicativa para la web, no una sustitución del flujo completo de la propuesta.",
		},
		momentos: {
			...
			rows: [
				{
					momento: "Antes",
					contenido:
						"Objetivo, diseño narrativo y de dinámicas, preparación de soportes y entorno previo cuando forme parte del alcance.",
					base: "Documento maestro, kit de producción y espacio digital.",
				},
				{
					momento: "Durante",
					contenido:
						"Personas participando, puntos de interacción y equipo que facilita, orienta y coordina.",
					base: "Roles y territorios, equipo y materialización.",
				},
				{
					momento: "Después",
					contenido:
						"Mapa del evento, informe, piezas editoriales y obras visuales, según el alcance contratado.",
					base: "Cuatro familias de entregables.",
				},
			],
			closingNote:
				"Numen no solo plantea una idea ni entrega un informe: diseña un sistema de participación, lo acompaña en vivo y da forma a lo que produce.",
		},
		entregables: {
			title: "La experiencia pasa. El conocimiento no tiene por qué perderse.",
			items: [
				{
					name: "Mapa del Evento",
					description:
						"Un mapa de relaciones e intereses construido a partir de las aportaciones de los participantes.",
				},
				{
					name: "Informe de inteligencia",
					description:
						"Una lectura de lo que la comunidad del evento sabe, necesita y produce.",
				},
				{
					name: "Opúsculos",
					description:
						"Piezas editoriales breves que desarrollan el conocimiento generado.",
				},
				{
					name: "Obras visuales",
					description:
						"Materiales visuales derivados de la experiencia, listos para compartir o exponer.",
				},
			],
			scopeNote:
				"No todos los entregables aparecen automáticamente en todos los proyectos: el alcance se acuerda con cada organización.",
		},
		valor: {
			title: "Valor para tres participantes de la compra",
			audiencias: [
				{
					label: "Para quienes asisten",
					body: "Oportunidades de participar y conectar alrededor de intereses y retos compartidos.",
				},
				{
					label: "Para el organizador",
					body: "Una lectura de lo que su comunidad sabe, necesita y produce.",
				},
				{
					label: "Para patrocinadores y colaboradores",
					body: "Participación con sentido y evidencias de la experiencia, según lo acordado.",
				},
			],
			...
			proyectos: [
				{
					...
					contexto:
						"El mayor evento gratuito de tecnología y cultura digital del mundo hispanohablante, celebrado en Madrid y retransmitido globalmente.",
					queHicimos:
						"Con Arcasiles, los organizadores, diseñamos un espacio jugable que permitía recorrer el evento —sus áreas, sus contenidos y sus dinámicas— en un único trayecto que integraba información, exploración y juego.",
				...
				},
				{
					...
					contexto:
						"El simposio anual del Active Inference Institute, que reúne a investigadores de todo el mundo en torno a un marco científico sobre cómo los sistemas inteligentes perciben, actúan y aprenden.",
					queHicimos:
						"Diseñamos un entorno donde los asistentes accedían a toda la información del simposio mientras recorrían una aventura de tipo escape room que introducía por experiencia los fundamentos del mapa de Active Inference: los cuatro estados y sus relaciones.",
				...
				},
				{
					...
					nombre: "Merge 2025",
					contexto:
						"Conferencia internacional sobre Web3 y activos digitales que actúa como puente entre los ecosistemas tecnológicos y financieros de Europa y Latinoamérica.",
					queHicimos:
						"Construimos un gemelo digital de la sede con elementos que simbolizan ese encuentro transatlántico, con acceso ordenado a la información de patrocinadores y socios y un enigma interactivo sobre qué representa Merge.",
					formato: "Emparejamiento conceptual",
					duracion: "15 min",
				...
				},
				{
					...
					contexto:
						"Cada 1 de enero nuevas obras entran en dominio público. Lo celebramos porque es coherente con nuestro compromiso con el código abierto y la producción en dominio público.",
					queHicimos:
						"Una aventura jugable ambientada en una imprenta ficticia que mezcla lo antiguo y lo futurista, donde se recorre la historia del copyright y el dominio público explorando en lugar de leyendo.",
				...
				},
				{
					...
					contexto:
						"Colaboración con el Active Inference Institute para comunicar por experiencia directa cómo los sistemas inteligentes reducen incertidumbre al interactuar con su entorno.",
					queHicimos:
						"Un recorrido que usa la percepción de la música como hilo conductor para atravesar los cuatro estados del modelo, desde los estados internos del cerebro hasta el mundo exterior.",
		...
		filosofia: {
			quote:
				"El juego nos interesa por lo que permite hacer juntos. La narrativa da sentido a la participación. Y la tecnología debe ayudar a conservar lo que una comunidad descubre, sin quitarle el protagonismo.",
	...
	experiencias: {
		...
		alcanceBody:
			"Diseñamos la narrativa y las dinámicas, preparamos los soportes necesarios, y facilitamos la experiencia en vivo durante el evento: guiamos, orientamos y coordinamos la participación.",
		...
		equipoBody:
			"Según el alcance contratado: un mapa del evento, un informe de inteligencia, opúsculos (piezas editoriales breves) y obras visuales derivadas de la experiencia.",
		condicionesTitle: "Condiciones por definir",
		condicionesBody:
			"Precio, plazos y alcance exacto se acuerdan encargo por encargo, en conversación directa con tu equipo. Esta página no sustituye esa conversación.",
		...
		fases: [
			{
				...
				responsabilidad:
					"Numen diseña; tu equipo valida el encaje con el objetivo real del evento.",
			},
			{
				title: "Durante",
				...
				responsabilidad:
					"Numen coordina en el terreno; tu equipo mantiene la relación con sus asistentes.",
			},
			{
				title: "Después",
				...
				responsabilidad:
					"Numen entrega y explica; tu equipo decide cómo y con quién comparte los resultados.",
			},
		],
		validacionTitle: "Puntos de validación",
		validacionBody:
			"En cada fase hay un punto explícito de acuerdo contigo antes de avanzar: el diseño, la logística del día, y el alcance final de los entregables. Nada se da por asumido sin confirmación.",
	...
	numen: {
		...
		colaboracionBody:
			"Trabajamos en conversación directa con quien decide la experiencia, el programa o la producción de tu encuentro. Empezamos por entender el objetivo antes de proponer una forma de conseguirlo.",
		cta: "Conocer al equipo y conversar",
	},
	footer: {
		tagline:
			"Diseñamos experiencias participativas: narrativa, dinámicas de juego y acompañamiento en vivo.",
	...
	telemetry: {
		...
		pending:
			"Pendiente: interacción con la página (qué se pulsa, qué se lee), rendimiento y consentimiento de cookies. Cuando exista, se medirá aquí, no se afirmará.",
		version: "Versión",
		commit: "Commit",
	},
	legal: {
	...
	contact: {
		...
		success:
			"Se abre tu correo con la consulta ya escrita. Si no se abre, cópiala y escríbenos a la dirección de abajo.",
...
const en: SiteDictionary = {
	...
	home: {
		...
		bloque2: {
			title:
				"We don't add a game to the agenda. We design how people take part.",
			...
			sequenceNote:
				"This is a simplified explanation for the website, not a replacement for the full flow described in the proposal.",
		},
		momentos: {
			...
			rows: [
				{
					momento: "Before",
					contenido:
						"Goal, narrative and mechanics design, preparation of materials and prior environment when part of the scope.",
					base: "Master document, production kit, and digital space.",
				},
				{
					momento: "During",
					contenido:
						"People participating, interaction points, and a team that facilitates, guides, and coordinates.",
					base: "Roles and territories, team, and delivery.",
				},
				{
					momento: "After",
					contenido:
						"Event map, report, editorial pieces, and visual works, according to the contracted scope.",
					base: "Four families of deliverables.",
				},
			],
			closingNote:
				"Numen doesn't just propose an idea or hand over a report: we design a participation system, run it live, and shape what it produces.",
		},
		entregables: {
			...
			items: [
				{
					name: "Event Map",
					description:
						"A map of relationships and interests built from participants' contributions.",
				},
				{
					name: "Intelligence report",
					description:
						"A reading of what the event's community knows, needs, and produces.",
				},
				{
					name: "Opúsculos (booklets)",
					description:
						"Short editorial pieces that develop the knowledge generated.",
				},
				{
					name: "Visual works",
					description:
						"Visual materials derived from the experience, ready to share or display.",
				},
			],
			scopeNote:
				"Not every deliverable is automatically included in every project: scope is agreed with each organization.",
		},
		valor: {
			...
			audiencias: [
				{
					label: "For attendees",
					body: "Opportunities to participate and connect around shared interests and challenges.",
				},
				{
					label: "For the organizer",
					body: "A reading of what their community knows, needs, and produces.",
				},
				{
					label: "For sponsors and partners",
					body: "Meaningful participation and evidence of the experience, as agreed.",
				},
			],
			...
			proyectos: [
				{
					...
					nombre: "Nerdearla 2025",
					contexto:
						"The largest free technology and digital culture event in the Spanish-speaking world, held in Madrid and streamed globally.",
					queHicimos:
						"With Arcasiles, the organizers, we designed a playable space that let visitors move through the event —its areas, its content and its dynamics— in a single journey combining information, exploration and play.",
				...
				},
				{
					...
					nombre: "AII Symposium 2025",
					contexto:
						"The annual symposium of the Active Inference Institute, bringing together researchers worldwide around a scientific framework for how intelligent systems perceive, act and learn.",
					queHicimos:
						"We designed an environment where attendees reached all symposium information while moving through an escape-room adventure that introduced the foundations of the Active Inference map by experience: the four states and their relations.",
				...
				},
				{
					...
					nombre: "Merge 2025",
					contexto:
						"An international conference on Web3 and digital assets acting as a bridge between the technological and financial ecosystems of Europe and Latin America.",
					queHicimos:
						"We built a digital twin of the venue with elements symbolising that transatlantic encounter, offering structured access to sponsor and partner information and an interactive puzzle about what Merge represents.",
					formato: "Conceptual matching",
					duracion: "15 min",
					enlace: "https://mmerge.io/es",
					enlaceLabel: "mmerge.io",
				},
				{
					...
					contexto:
						"Every January 1st new works enter the public domain. We celebrate it because it is coherent with our commitment to open-source code and public domain production.",
					queHicimos:
						"A playable adventure set in a fictional printing press mixing the antique and the futuristic, where the history of copyright and the public domain is covered by exploring rather than reading.",
				...
				},
				{
					...
					contexto:
						"A collaboration with the Active Inference Institute to communicate through direct experience how intelligent systems reduce uncertainty by interacting with their environment.",
					queHicimos:
						"A journey using the perception of music as its guiding thread to move through the four states of the model, from internal brain states to the external world.",
		...
		filosofia: {
			quote:
				"We care about games for what they let us do together. Narrative gives participation meaning. And technology should help preserve what a community discovers, without taking the spotlight from it.",
	...
	experiencias: {
		...
		alcanceBody:
			"We design the narrative and mechanics, prepare the necessary materials, and facilitate the experience live during the event: guiding, directing, and coordinating participation.",
		...
		equipoBody:
			"Depending on the contracted scope: an event map, an intelligence report, opúsculos (short editorial pieces), and visual works derived from the experience.",
		condicionesTitle: "Conditions to be defined",
		condicionesBody:
			"Price, timelines, and exact scope are agreed on a project-by-project basis, in direct conversation with your team. This page doesn't replace that conversation.",
		...
		fases: [
			{
				...
				responsabilidad:
					"Numen designs; your team validates the fit with the event's actual goal.",
			},
			{
				title: "During",
				...
				responsabilidad:
					"Numen coordinates on the ground; your team keeps the relationship with its attendees.",
			},
			{
				title: "After",
				...
				responsabilidad:
					"Numen delivers and explains; your team decides how and with whom to share the results.",
			},
		],
		validacionTitle: "Validation points",
		validacionBody:
			"At every phase there's an explicit point of agreement with you before moving forward: the design, the day's logistics, and the final scope of deliverables. Nothing is assumed without confirmation.",
		cta: "Assess the fit",
	},
	numen: {
		title: "Numen",
		...
		colaboracionBody:
			"We work in direct conversation with whoever decides the experience, program, or production of your gathering. We start by understanding the goal before proposing a way to achieve it.",
		cta: "Meet the team and talk",
	},
	footer: {
		tagline:
			"We design participatory experiences: narrative, game dynamics, live facilitation.",
		contactEmail: "hola@numen.games",
	...
	telemetry: {
		...
		pending:
			"Pending: interaction with the page (what is clicked, what is read), performance and cookie consent. When it exists it will be measured here, not asserted.",
		version: "Version",
		commit: "Commit",
	},
	legal: {
	...
	contact: {
		...
		success:
			"Your email client opens with the inquiry already written. If it does not, copy it and write to the address below.",
