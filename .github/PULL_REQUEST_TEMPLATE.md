...
- [ ] Visual changes follow the Design System v5.0.0: colours from the canonical tokens only, Geist/Geist Mono only, spacing on the 4 scale, motion from the §10.1 catalogue
